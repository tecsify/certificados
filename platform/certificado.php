...
if (preg_match($pattern, $uuid, $matches)) {
    ...
    // Redirigir si no se encuentra el UUID
    header('Location: /');
    exit;
}
...
<body>
    ...
    <script>
        ...
        document.getElementById('shareLinkedInButton').addEventListener('click', function() {
            ...
            var linkedInShareURL = "https://www.linkedin.com/shareArticle?mini=true&url=" + encodeURIComponent(currentURL)+ "/#0000/&title=" + encodeURIComponent(shareMessage) + "&source=Tecsify";
